...
```{r data}
df_char_vis <- tuesdata$character_visualization
...
```{r convert}
## convert to png
pdf_convert(pdf = here::here("plots", "2020_27", "2020_27_Xmen_clean.pdf"),
            format = "png", dpi = 350)
pdf_convert(pdf = here::here("plots", "2020_27", "2020_27_Xmen_annotated.pdf"),
            format = "png", dpi = 350)
```
